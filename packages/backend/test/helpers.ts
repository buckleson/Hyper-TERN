...
import { PricingCatalogModule } from '../src/pricing-catalog/pricing-catalog.module';
...
export const TEST_OTLP_KEY = 'htrn_test-otlp-key-001';
...
export async function createTestApp(): Promise<INestApplication> {
  ...
  try {
    ...
    const pricingCache = app.get(PricingCatalogCacheService);
