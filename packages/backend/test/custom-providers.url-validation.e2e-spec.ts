...
describe('Custom Providers URL validation (e2e)', () => {
  ...
  describe('POST — service-layer SSRF guard (cloud mode)', () => {
    ...
    // is bypassed and the real cloud-mode behavior runs. HYPER_TERN_MODE is
    ...
    beforeEach(() => {
      ...
      originalMode = process.env['HYPER_TERN_MODE'];
    ...
    it('rejects plaintext http:// to a public host in cloud mode as 400', async () => {
      ...
      // The error message hints at HYPER_TERN_MODE=selfhosted; the "https"
