...
describe('SessionGuard', () => {
  ...
  describe('cloud mode (default) — no loopback fallback', () => {
    const originalEnv = process.env['HYPER_TERN_MODE'];
    ...
    afterEach(() => {
      if (originalEnv === undefined) delete process.env['HYPER_TERN_MODE'];
      else process.env['HYPER_TERN_MODE'] = originalEnv;
    });
    ...
    it('does NOT inject synthetic user when HYPER_TERN_MODE is "cloud"', async () => {
