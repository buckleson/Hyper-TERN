...
export function TestEmail(props: TestEmailProps = {}) {
  const { logoUrl = 'https://app.hyper-tern.build/hyper-tern-logo.png' } = props;
  return (
    <Html>
      <Head />
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={logoSection}>
            <Img src={logoUrl} alt="Hyper-Tern" height="32" style={logoImg} />
          </Section>
          ...
          <Section style={card}>
            ...
            <Text style={paragraph}>
              This is a test email from Hyper-Tern. If you're reading this, your email provider
          ...
          <Section style={footer}>
            <Text style={footerNote}>This is a one-time test email sent from Hyper-Tern.</Text>
            <Text style={footerMuted}>
              © 2026 Hyper-Tern Inc. All rights reserved.{' '}
              <Link href="https://hyper-tern.build" style={footerLink}>
                hyper-tern.build
              </Link>
            </Text>
          </Section>
