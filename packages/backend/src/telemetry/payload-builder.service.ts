...
import { AUTH_TYPES, TIER_SLOTS } from 'hyper-tern-shared';
...
export class PayloadBuilderService {
  ...
  async build(installId: string, hyperTernVersion: string): Promise<TelemetryPayloadV1> {
    ...
    return {
      ...
      hyper_tern_version: hyperTernVersion,
