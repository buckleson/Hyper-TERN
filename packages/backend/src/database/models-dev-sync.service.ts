...
import { normalizeProviderName, type ModelCapability, type ModelModality } from 'hyper-tern-shared';
import { PROVIDER_BY_ID_OR_ALIAS } from '../common/constants/providers';
import {
  capabilitiesFromModelsDev,
  modelModalitiesFromModelsDev,
} from '../model-discovery/model-capabilities';
import { GOOGLE_VARIANT_RE } from '../pricing-catalog/model-name-normalizer';
...
export class ModelsDevSyncService implements OnModuleInit {
  ...
  /** Map: models.dev provider ID → Map<model ID, entry>. Includes providers Hyper-Tern does not natively know. */
  ...
  onModuleInit(): void {
    ...
    // trip Railway's healthcheck (see #1894). PricingCatalogCacheService awaits
