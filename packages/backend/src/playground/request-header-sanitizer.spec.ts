...
describe('sanitizeRequestHeaders', () => {
  ...
  it('drops x-hyper-tern-* headers from the client regardless of casing', () => {
    const out = sanitizeRequestHeaders({
      'X-Hyper-Tern-Specificity': 'trading',
      'x-hyper-tern-tier': 'reasoning',
      'X-Title': 'ok',
    });
  ...
  it('isBlockedHeaderName is case-insensitive and covers prefixes', () => {
    ...
    expect(isBlockedHeaderName('X-Hyper-Tern-Anything')).toBe(true);
