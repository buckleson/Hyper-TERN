...
import { AUTH_TYPES } from 'hyper-tern-shared';
 ...
 *
 * `messages` is the chat-completions shape Hyper-Tern builds itself; replay
...
export class RunPlaygroundDto {
   ...
   * Sanitized server-side — Hyper-Tern-managed and transport-layer headers
