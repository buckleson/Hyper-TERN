...
import type { AuthType, ModelRoute, ResponseMode } from 'hyper-tern-shared';
import {
...
import { isHyperTernUsableProvider } from '../../common/utils/subscription-support';
...
export class TierService {
  ...
  async getTiers(agentId: string, userId?: string): Promise<TierAssignment[]> {
    ...
    const usableProviders = providers.filter(isHyperTernUsableProvider);
