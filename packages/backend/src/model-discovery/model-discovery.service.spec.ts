...
describe('ModelDiscoveryService', () => {
  ...
  describe('enrichModel pricing boundary conditions', () => {
    ...
    it('uses known-prices when no upstream source has data', async () => {
      mockModelsDevSync.lookupModel.mockReturnValue(null);
    ...
    it('known-prices wins over models.dev for curated models', async () => {
    ...
    it('known-prices wins over OpenRouter for curated models', async () => {
      ...
      // it at a different price in known-prices.
      mockModelsDevSync.lookupModel.mockReturnValue(null);
      mockPricingSync.lookupPricing.mockReturnValue({
