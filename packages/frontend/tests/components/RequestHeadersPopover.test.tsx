...
describe('isBlockedHeaderKey', () => {
  it('flags Hyper-Tern-managed and transport-layer headers case-insensitively', () => {
    ...
    expect(isBlockedHeaderKey('X-Hyper-Tern-Trace')).toBe(true);
  });
...
describe('RequestHeadersPopover', () => {
  ...
  it('shows an inline warning when the user types a Hyper-Tern-managed key', () => {
