...
import type { ProviderParamSpec, RequestParamDefaults } from 'hyper-tern-shared';
...
describe('ModelParamsDialog', () => {
  ...
  it('shows a compact request action when no parameter specs are published', () => {
    render(() => (
      <ModelParamsDialog
        {...baseProps}
        specs={[]}
        requestParamsUrl="https://github.com/Hyper-Tern/modelparams.dev/issues/new?template=parameter-request.yml&provider=openai&model=gpt-4o"
        slotLabel="gpt-4o"
      />
    ));
    ...
    expect(link).toHaveProperty(
      'href',
      'https://github.com/Hyper-Tern/modelparams.dev/issues/new?template=parameter-request.yml&provider=openai&model=gpt-4o',
    );
  });
  ...
  it('shows the compact request link alongside published parameter controls', () => {
    render(() => (
      <ModelParamsDialog
        {...baseProps}
        requestParamsUrl="https://github.com/Hyper-Tern/modelparams.dev/issues/new?template=parameter-request.yml&provider=deepseek&model=deepseek-v4"
      />
    ));
    ...
    expect(link).toHaveProperty(
      'href',
      'https://github.com/Hyper-Tern/modelparams.dev/issues/new?template=parameter-request.yml&provider=deepseek&model=deepseek-v4',
    );
  });
