...
const suggestions: HeaderSuggestion[] = [
  { label: 'x-hyper-tern-tier', value: 'x-hyper-tern-tier', sublabel: '12× · premium · free', group: 'openai-js' },
...
describe('HeaderComboBox', () => {
  ...
  it('filters suggestions by typed prefix (case-insensitive)', () => {
    ...
    expect(container.textContent).not.toContain('x-hyper-tern-tier');
  });
  ...
  it('selects a suggestion via mousedown and fires onInput', () => {
    ...
    expect(onInput).toHaveBeenCalledWith('x-hyper-tern-tier');
  });
