...
describe('ProviderSubscriptionTab', () => {
  it('renders the hint, link, and falls back to default "Subscription" label', () => {
    ...
    expect(link.getAttribute('href')).toBe('https://github.com/TheHyper-TERN/hyper-tern/discussions/973');
  ...
  it.each([
    ...
    ['subscriptionCommand', { subscriptionCommand: 'hyper-tern auth login cmd' }],
