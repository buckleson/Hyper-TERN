...
import { platformIcon } from 'hyper-tern-shared';
        ...
        >
          ...
          <Show when={isEnable()}>
            <p class="modal-card__desc">
              Connect your agent to Hyper-Tern to start routing requests.
            </p>
          </Show>
            ...
            fallback={
              <>
                <p style="margin: 0 0 14px; font-size: var(--font-size-sm); color: hsl(var(--muted-foreground)); line-height: 1.5;">
                  This will stop routing requests through Hyper-Tern and restore direct model access
