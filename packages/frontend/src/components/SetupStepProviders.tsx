  ...
  return (
    <div>
      ...
      <p class="setup-step__desc">
        Hyper-Tern routes each request to the best model for the job. Connect at least one provider so{' '}
        <code class="api-key-display__code">hyper-tern/auto</code> can resolve requests.
      </p>

      <div class="api-key-display__warning" style="margin-bottom: 16px;">
        Without a connected provider, requests to{' '}
        <code class="api-key-display__code">hyper-tern/auto</code> will return an error.
      </div>
