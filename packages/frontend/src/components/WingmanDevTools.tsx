...
const STORAGE_OPEN = 'hyper-tern:wingman:open';
const STORAGE_HEIGHT = 'hyper-tern:wingman:height';
...
const WingmanDevTools: Component = () => {
  ...
  // Wingman is a hosted SPA at wingman.hyper-tern.build. A build-time
  // `VITE_WINGMAN_URL` override still wins so contributors can point the
  // drawer at a locally-running Wingman build.
  const HOSTED_WINGMAN_URL = 'https://wingman.hyper-tern.build';
