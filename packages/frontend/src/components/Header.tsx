...
const Header: Component<HeaderProps> = (props) => {
  ...
  const docsUrl = () => {
    ...
    if (p.includes('/limits')) return 'https://hyper-tern.build/docs/set-limits';
    if (p.includes('/routing')) return 'https://hyper-tern.build/docs/routing';
    return 'https://hyper-tern.build/docs/introduction';
  };
    ...
    <header class="header">
      <div class="header__left">
        ...
        <Show when={isSelfHosted()}>
          <span class="header__mode-badge" title="Running on the self-hosted version of Hyper-Tern">
            Self-hosted
          </span>
        </Show>
        {__DEV_MODE__ && (
