    ...
    <div>
      <h3 class="setup-step__heading">
        {props.platform === 'hermes'
          ? 'Connect your Hermes agent to Hyper-Tern'
          : props.platform === 'openclaw'
            ? 'Connect your OpenClaw agent to Hyper-Tern'
            : props.platform === 'nanobot'
              ? 'Connect your Nanobot agent to Hyper-Tern'
              : props.platform === 'craft'
                ? 'Connect your Craft agent to Hyper-Tern'
                : props.platform === 'claude-code'
                  ? 'Connect Claude Code to Hyper-Tern'
                  : props.platform === 'opencode'
                    ? 'Connect OpenCode to Hyper-Tern'
                    : 'Connect your agent to Hyper-Tern'}
      </h3>
      ...
      <Show when={!isFiltered()}>
        <p class="setup-step__desc">
          Point your agent at the Hyper-Tern endpoint using the model{' '}
