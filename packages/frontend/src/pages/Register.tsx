...
const Register: Component = () => {
  ...
  return (
    <>
      <Title>Sign Up - Hyper-Tern</Title>
      <Meta
        name="description"
        content="Create a Hyper-Tern account to start monitoring your AI agents."
      />
      <Show
        when={emailSent()}
        fallback={
          <>
            ...
            <p class="auth-terms">
              ...
              <a
                href="https://hyper-tern.build/terms"
              ...
              and{' '}
              <a
                href="https://hyper-tern.build/privacy"
                class="auth-terms__link"
                target="_blank"
                rel="noopener noreferrer"
              >
