...
const Setup: Component = () => {
  ...
  return (
    <>
      <Title>Set up Hyper-Tern</Title>
      <Meta name="description" content="Create the admin account for your Hyper-Tern instance." />
      <Show when={!checking()} fallback={<div class="auth-header__subtitle">Loading...</div>}>
        <div class="auth-header">
          <h1 class="auth-header__title">Welcome to Hyper-Tern</h1>
